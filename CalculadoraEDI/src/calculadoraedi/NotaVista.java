...
public class NotaVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Si vas a indicar números negativos, utiliza la función (-). ");

        jLabel2.setText("La calculadora no permitirá que utilices la resta después");

        jLabel3.setText("de otro operador para indicar a un numero negativo. ");
